...
public class LuphieSmallStorageGuiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public LuphieSmallStorageGuiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(LuphieclutteredmodModMenus.LUPHIE_SMALL_STORAGE_GUI.get(), id);
