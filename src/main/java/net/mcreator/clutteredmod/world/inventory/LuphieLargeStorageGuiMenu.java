...
public class LuphieLargeStorageGuiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public LuphieLargeStorageGuiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(LuphieclutteredmodModMenus.LUPHIE_LARGE_STORAGE_GUI.get(), id);
