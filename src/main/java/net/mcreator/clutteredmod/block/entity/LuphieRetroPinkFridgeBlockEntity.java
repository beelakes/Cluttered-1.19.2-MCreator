...
public class LuphieRetroPinkFridgeBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	...
	public LuphieRetroPinkFridgeBlockEntity(BlockPos position, BlockState state) {
		super(LuphieclutteredmodModBlockEntities.LUPHIE_RETRO_PINK_FRIDGE.get(), position, state);
	}
